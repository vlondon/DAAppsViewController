Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/rbaulin/DAAppsViewController'
  s.author   = { 'Daniel Amitay' => 'hello@danielamitay.com', 'Roman Baulin' => 'rbaulin@gmail.com' }
  s.source   = { :git => 'https://github.com/rbaulin/DAAppsViewController.git', :tag => s.version.to_s }
